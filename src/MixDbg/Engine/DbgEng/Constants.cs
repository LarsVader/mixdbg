...
{
    public const uint NoDebuggee = 1;
    public const uint Break = 6;
    public const uint Go = 10;
    public const uint StepOver = 12;
    public const uint StepInto = 13;
    public const uint StepBranch = 14;
    public const uint GoNotHandled = 8;
    public const uint GoHandled = 9;
}
